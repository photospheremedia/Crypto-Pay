...
def main():
    ...
    # Prepare payload
    payload = {
        "mailer_subjects_confirmation": "Confirm Your Restaurant Hub Account",
        "mailer_subjects_recovery": "Reset Your Password - Restaurant Hub",
        "mailer_subjects_invite": "You've Been Invited to Restaurant Hub",
        "mailer_subjects_magic_link": "Your Login Link - Restaurant Hub",
        "mailer_subjects_email_change": "Confirm Your New Email - Restaurant Hub",
