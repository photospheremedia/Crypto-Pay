...
|----------|-------------|
| [../.agents/skills/dev-workflow/SKILL.md](../.agents/skills/dev-workflow/SKILL.md) | Agent dev workflow: health checks, docs order (skills → MCP → CLI → web) |
| [LOCAL_DEV.md](./LOCAL_DEV.md) | Local env, `dev:setup`, Supabase redirect URLs |
