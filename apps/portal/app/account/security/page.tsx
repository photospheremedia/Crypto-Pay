...
export default async function SecurityPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-orange-200/60 bg-linear-to-br from-orange-50/50 to-teal-50/30 p-6">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-orange-500 to-teal-500 shadow-lg shadow-orange-200/50">
      ...
      <div className="rounded-xl border border-slate-200/60 bg-linear-to-br from-white to-slate-50/50 shadow-sm">
        <div className="p-6 border-b border-slate-200/60">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-amber-500 to-orange-500 shadow-md">
          ...
          <div className="space-y-3">
            {identities.map((identity) => (
              <div key={identity.id} className="flex items-center justify-between p-4 border border-slate-200/60 bg-white/50 rounded-xl hover:border-slate-300 transition-colors">
                ...
                <span className="inline-flex items-center rounded-full bg-orange-100 px-3 py-1 text-xs font-semibold text-orange-600 border border-orange-200">
                  ✓ Active
                </span>
              </div>
            ))}
      ...
      <div className="rounded-xl border-2 border-red-200/60 bg-linear-to-br from-red-50/50 to-orange-50/30 shadow-sm">
        <div className="p-6 sm:p-8">
          <div className="flex flex-col sm:flex-row sm:items-start gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-red-500 to-orange-500 shadow-md shrink-0">
