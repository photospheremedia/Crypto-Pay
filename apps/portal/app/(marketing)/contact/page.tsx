...
export default function ContactPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-6 pt-24 pb-16 lg:pt-28">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div>
              <input
                ...
                className={`w-full rounded-xl border px-4 py-3 text-sm text-slate-700 outline-none transition focus:border-orange-300 focus:ring-2 focus:ring-orange-100 ${
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 outline-none transition focus:border-orange-300 focus:ring-2 focus:ring-orange-100"
            />
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-full bg-orange-500 px-6 py-3 font-semibold text-white shadow-lg shadow-orange-200/60 transition hover:bg-orange-600 disabled:cursor-not-allowed disabled:opacity-70"
            >
              {isSubmitting ? (
                <>
      ...
      {/* Demo CTA */}
      <div className="mt-12 flex flex-wrap items-center justify-between gap-6 rounded-[28px] border border-slate-200 bg-linear-to-r from-orange-50 to-white px-8 py-6 shadow-sm">
        <div>
