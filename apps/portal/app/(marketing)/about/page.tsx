    ...
    <section className="mx-auto w-full max-w-6xl px-6 pt-24 pb-16 lg:pt-28">
      ...
      <div className="mt-16 grid gap-4 sm:grid-cols-2 md:grid-cols-4">
        {stats.map((stat) => {
          ...
          return (
            <div
              key={stat.label}
              className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:border-orange-200 hover:shadow-lg"
            >
              <Icon className="h-6 w-6 text-orange-500 transition group-hover:scale-110" />
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {values.map((value) => {
            ...
            return (
              ...
              >
                <div className="inline-flex rounded-2xl bg-orange-100 p-3 transition group-hover:bg-orange-200">
      ...
      <div className="mt-16">
        ...
        <div className="relative mt-10">
          <div className="absolute left-4 top-0 h-full w-0.5 bg-orange-100 md:left-1/2 md:-translate-x-1/2" />
          <div className="space-y-8">
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className="absolute left-4 top-1 h-3 w-3 rounded-full bg-orange-500 md:left-1/2 md:-translate-x-1/2" />
      ...
      <div className="mt-16 overflow-hidden rounded-[28px] bg-linear-to-r from-orange-500 to-orange-600 p-10 text-white">
        <div className="flex flex-wrap items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/signup"
              className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-orange-600 transition hover:bg-orange-50"
            >
              Book a demo
            </Link>
            <Link
