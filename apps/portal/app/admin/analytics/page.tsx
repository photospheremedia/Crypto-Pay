          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={`flex items-center gap-1 text-sm font-medium ${
                    stats?.revenue.trend === "up" ? "text-orange-500" : "text-red-600"
                  }`}
                >
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={`flex items-center gap-1 text-sm font-medium ${
                    stats?.orders.trend === "up" ? "text-orange-500" : "text-red-600"
                  }`}
                >
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={`flex items-center gap-1 text-sm font-medium ${
                    stats?.customers.trend === "up" ? "text-orange-500" : "text-red-600"
                  }`}
                >
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={`flex items-center gap-1 text-sm font-medium ${
                    stats?.avgOrderValue.trend === "up" ? "text-orange-500" : "text-red-600"
                  }`}
                >
                    ...
                    <div key={order.id} className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className={`text-xs capitalize ${
                          order.status === "completed" ? "text-orange-500" :
