    ...
    <section className="mx-auto w-full max-w-4xl px-6 py-16">
      ...
      <div className="prose prose-slate mt-10 max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                Your use of the Service is also governed by our <Link href="/privacy-policy" className="text-emerald-500 hover:text-emerald-600 font-medium">Privacy Policy</Link>, 
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                Before filing a claim, contact us at <a href="mailto:support@cryptopay.sale" className="text-emerald-500 hover:text-emerald-600 font-medium">support@cryptopay.sale</a> to 
            ...
            <section className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
                ...
                <p className="text-slate-700 mb-2">Email: <a href="mailto:support@cryptopay.sale" className="text-emerald-500 hover:text-emerald-600 font-medium">support@cryptopay.sale</a></p>
