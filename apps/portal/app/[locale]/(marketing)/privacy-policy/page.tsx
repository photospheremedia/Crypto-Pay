    ...
    <MarketingPageShell narrow>
      ...
      <div className="prose prose-slate mt-10 max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                To exercise these rights, contact us at <a href="mailto:support@cryptopay.sale" className="text-emerald-500 hover:text-emerald-600 font-medium">support@cryptopay.sale</a>
              </p>
            </section>
