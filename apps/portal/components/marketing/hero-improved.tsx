      ...
      <div className="relative mx-auto max-w-6xl px-6 sm:px-8">
        ...
        <div className="mb-8 text-center max-w-4xl mx-auto">
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 mb-6">
            Stop losing profits to <span className="text-emerald-600">delivery app fees</span>
          </h1>
        ...
        <div className="mt-16 max-w-2xl mx-auto bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-lg transition">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-emerald-600 mb-2">FEATURED CASE STUDY</p>
              <p className="text-lg font-bold text-slate-900 mb-2">
                Thai Kitchen LA saved <span className="text-emerald-600">$65,000</span> in commission fees
              </p>
